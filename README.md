...
__Get Note Link__ [1] | Gets a link to the Evernote note passed into the action, which can be shared.<br><br>__In-App Link__<br><br>When enabled, an evernote:// URL will be generated, suitable for opening the note in the Evernote app.<br><br>__Result__<br>URLS<br><br>__Requires__<br>Access to your Evernote account
__Get Note Link__ [2] | Gets a link to the Evernote note passed into the action, which can be shared.<br><br>__In-App Link__<br><br>When enabled, an evernote:// URL will be generated, suitable for opening the note in the Evernote app.<br><br>__Result__<br>URLS<br><br>__Requires__<br>Access to your Evernote account
